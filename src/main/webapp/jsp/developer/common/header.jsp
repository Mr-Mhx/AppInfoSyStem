...
<c:if test="${sessionScope.devUserSession ==null}">
	<script> alert("请登录！");location.href='${pageContext.request.contextPath}/index.jsp'</script>
</c:if>
<!DOCTYPE html>
<html lang="en">
<head>
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> APP应用管理<span
									...
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath }/appInfoCon/appList">APP维护</a>
										</li>
									</ul></li>
							</ul>
						</div>
