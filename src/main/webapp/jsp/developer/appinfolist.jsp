...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form method="post" action="${pageContext.request.contextPath}/appInfoCon/appList">
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input placeholder="请输入软件名称" name="softwarename" type="text" class="form-control col-md-7 col-xs-12"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <select name="categorylevel2" id="queryCategoryLevel2" class="form-control">
                                        <c:if test="${queryCategoryLevel2List != null }">
                                            <option value="">--请选择--</option>
                                            <c:forEach var="appCategory" items="${queryCategoryLevel2List}">
                                                <option
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="categorylevel3" id="queryCategoryLevel3" class="form-control">
                                        <c:if test="${queryCategoryLevel3List != null }">
                                            <option value="">--请选择--</option>
                                            <c:forEach var="appCategory" items="${queryCategoryLevel3List}">
                                                <option
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <table id="datatable-responsive"
                                ...
                                <tbody>
                                <c:forEach var="appInfo" items="${appInfos.list }" varStatus="status">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="dataTables_info" id="datatable-responsive_info"
                                 role="status" aria-live="polite">共${appInfos.total }条记录
                                ${appInfos.pageNum }/${appInfos.pages }页
                            </div>
                        </div>
                        <div class="col-sm-7">
                                ...
                                <ul class="pagination">
                                    <c:if test="${appInfos.pageNum > 1}">
                                        ...
                                        <li class="paginate_button "><a
                                                href="javascript:page_nav(document.forms[0],${appInfos.pageNum-1});"
                                                aria-controls="datatable-responsive" data-dt-idx="1"
                                                tabindex="0">上一页</a>
                                        </li>
                                    </c:if>
                                    <c:if test="${appInfos.pageNum < appInfos.pages }">
                                        <li class="paginate_button "><a
                                                href="javascript:page_nav(document.forms[0],${appInfos.pageNum+1 });"
                                                aria-controls="datatable-responsive" data-dt-idx="1"
                                                tabindex="0">下一页</a>
                                        ...
                                        <li class="paginate_button next"><a
                                                href="javascript:page_nav(document.forms[0],${appInfos.total });"
