...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>新增APP版本信息 <i class="fa fa-user"></i><small>${sessionScope.devUserSession.devname}</small></h2>
            <div class="clearfix"></div>
      </div>
      <div class="x_title">
            <h2>历史版本列表</h2>
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
        ...
        <div class="x_content" style="display: block;">
         <br>
        <form class="form-horizontal form-label-left" action="/versionCon/addversionsave" method="post" enctype="multipart/form-data">
           <input type="hidden" name="appid" name="appId" value="${sessionScope.appVersion}">
